...
if __name__ == '__main__':
    ...
    track_data = np.loadtxt('../raw_data/{}/real.data'.format(data)).astype(int)
    rank_list = np.load('../preprocess_data/{}/rank_list.npy'.format(data))
    ...
    np.save('../preprocess_data/{}/burst_list'.format(data), burst_list)
    ...
    np.save('../preprocess_data/{}/burst_rank_list'.format(data), burst_rank_list)
    ...
    np.save('../preprocess_data/{}/burst_matrix'.format(data), burst_matrix)
